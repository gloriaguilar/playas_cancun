...
$info_places = array(
    ...
    "holbox" => array(
        ...
        "descripcion"  => "Una de las mejores Islas que rodean el estado de Quitana Roo. Pasar una noche ahí es garantía de que ¡no querras irte! Ofree una extensa variedad de cocina del mar, ¡te vas a enamorar cuando veas lo cristalina que se el mar! Definitivamente es un lugar que si o si debes visitar."
    ),
);
